...
import { AtNoticebar, AtGrid, AtAccordion, AtList, AtListItem } from "taro-ui"
import "./index.css"
  ...
  render() {
    return (
      <View className="index">
        ...
        <AtAccordion
          title="标题三"
          icon={{ value: "share", color: "red", size: "15" }}
          open={this.state.open}
          onClick={this.handleClickAAA.bind(this)}
        >
